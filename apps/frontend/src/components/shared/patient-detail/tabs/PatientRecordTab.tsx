    ...
    <PanelShell>
      <SectionCard title="" subtitle="">
        ...
        <div className="mb-6 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4 pb-6 border-b border-slate-200">
          ...
          <div>
            <p className="text-xs font-semibold uppercase tracking-wider text-gray-900 mb-1">Frecuencia</p>
          ...
          <div>
            <p className="text-xs font-semibold uppercase tracking-wider text-gray-900 mb-1">Fecha de inicio del tratamiento</p>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div>
            <h3 className="text-xs font-bold uppercase tracking-wider text-gray-900 mb-4">Datos personales</h3>
            <div className="space-y-3">
              ...
              <div>
                <p className="text-xs font-medium uppercase tracking-wider text-gray-900 mb-1">Motivo de consulta (actual)</p>
          ...
          <div>
            <h3 className="text-xs font-bold uppercase tracking-wider text-gray-900 mb-4">Datos de contacto</h3>
            <div className="space-y-3">
