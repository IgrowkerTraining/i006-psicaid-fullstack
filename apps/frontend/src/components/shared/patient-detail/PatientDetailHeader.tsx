  ...
  return (
    <header className="mb-6">
      <button
        type="button"
        onClick={onBack}
        className="group mb-4 inline-flex items-center gap-2 rounded-[20px] border border-[var(--border)] bg-brand-primario px-4 py-2 text-sm font-medium text-white shadow-[0_8px_20px_rgba(9,2,36,0.06)] transition hover:-translate-y-0.5 hover:border-[var(--brand-secundario)] hover:bg-brand-hover-primario cursor-pointer"
      >
