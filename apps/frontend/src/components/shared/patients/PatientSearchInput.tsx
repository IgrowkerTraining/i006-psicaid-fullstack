  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <input
        ...
        className="h-12 w-full rounded-xl border border-slate-700 bg-slate-900/40 pl-11 pr-10 text-sm text-slate-100 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
      />
